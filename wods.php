...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
          <h2 class="text-center">Neki od nasih treninga</h2>
          <?php if (empty($_SESSION['user'])){ ?>
            <p class="text-center">Morati biti ulogovani da biste postavili vase vreme</p>
          <?php } ?>
        <div class="row" id="treninzi">
  ...
  <script>
      $.ajax({
          url: 'kontroler.php?akcija=svi_treninzi',
          success: function (podaci) {
              $("#treninzi").html(podaci);
          }
      })
  </script>
